...
Route::middleware(['auth', CheckUserId::class . ':0,1,5'])->group(function () {
...
Route::middleware(['auth', CheckUserId::class . ':0,3,7'])->group(function () {
...
Route::middleware(['auth', CheckUserId::class . ':0,4,8'])->group(function () {
